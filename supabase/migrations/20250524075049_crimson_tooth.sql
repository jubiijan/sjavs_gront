/*
  # Score History and Game Functions
  ...
  2. Functions
    - calculate_trick_points: Calculate points for a trick
    - update_scores: Update player scores with validation
    - check_game_end: Check if game is finished
    - evaluate_trick: Evaluate trick winner and points
  
  3. Security
    - Enable RLS on score_history
    - Add policies for viewing and creating score history
*/
