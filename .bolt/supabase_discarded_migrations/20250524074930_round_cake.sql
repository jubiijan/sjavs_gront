/*
  # Score History and Game Functions Update
  ...
  2. New Functions
    - `calculate_trick_points`: Calculates points for winning a trick
    - `update_scores`: Updates player scores with validation
    - `check_game_end`: Checks for game completion conditions
    - `evaluate_trick`: Evaluates trick winner and points

  3. Security
    - RLS enabled on score_history table
    - Policies for viewing and creating score history records
*/
...
DROP FUNCTION IF EXISTS check_game_end(UUID);
